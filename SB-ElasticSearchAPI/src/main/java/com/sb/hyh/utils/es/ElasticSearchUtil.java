...
public class ElasticSearchUtil {
	private static Client client = ESFactory.getElasticSearch("172.17.80.108");
	...
	public static IndexResponse add(String index, String type, String json) {
		...
		return requestBuilder.setSource(json).execute().actionGet();
	}
	...
	public static List<Medicine> search(QueryBuilder queryBuilder, String index, String type) {
		List<Medicine> list = new LinkedList<Medicine>();
		// .setMinScore((float) 3).setSize(10)
